...
export default function NewItemPage() {
  ...
  const defaultCategory = searchParams.get("category") || "fish";

  const [saving, setSaving] = useState(false);
  const [formData, setFormData] = useState({
    id: "",
    name: "",
    category: defaultCategory as "fish" | "pole" | "lure",
    waterType: "pond" as "pond" | "river" | "ocean" | "night" | "",
    tier: "1",
    buyPrice: "0",
    sellPrice: "10",
    stackSize: "5",
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="e.g., fish_pond_5, pole_5, lure_5"
                  required
                />
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(v) => setFormData({
                    ...
                    spriteId: "",
                    stackSize: v === "pole" ? "1" : v === "lure" ? "99" : "5",
